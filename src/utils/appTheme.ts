...
export const themeMap: Record<GlobalThemeMode, AppThemeTokens> = {
  ...
  matrix: {
    ...
    codeBg: "bg-black border border-emerald-500/30 text-emerald-400",
  ...
  corporate: {
    ...
    tabActive: "border-slate-800 text-slate-800",
    ...
    modalBg: "bg-white text-slate-800 border border-slate-200",
